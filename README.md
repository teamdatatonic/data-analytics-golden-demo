...
| Workflows | Workflows Demo | Deploy, execute and destroy Wokflows to automatically run the Dataform, described above | [Link](https://github.com/GoogleCloudPlatform/data-analytics-golden-demo/blob/main/cloud-composer/data/wokflow/bigquery_dataform_execute.yaml) | Video |
